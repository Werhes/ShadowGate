...
// ---------------------------------------------------------------------------
// TLS config: InsecureSkipVerify + session cache
// ---------------------------------------------------------------------------
...
// Глобальный TLS-конфиг с session resumption cache
...
impl RawWebSocket {
    ...
    // Recv обрабатывает контрольные фреймы
...
// wsConnectOnce — заголовки как в Python raw_websocket.py
